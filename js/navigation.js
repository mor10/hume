...
(function( $ ) {
	...
	(function() {
		...
		menuToggle.on( 'click.hume', function() {
	...
	(function() {
		...
		function toggleFocusClassTouchScreen() {
			if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
				...
				$( document.body ).on( 'touchstart.hume', function( e ) {
				...
				siteNavigation.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.hume' );
			}
		}

		if ( 'ontouchstart' in window ) {
			$( window ).on( 'resize.hume', toggleFocusClassTouchScreen );
			toggleFocusClassTouchScreen();
		}

		siteNavigation.find( 'a' ).on( 'focus.hume blur.hume', function() {
	...
	$( document ).ready( function() {
		$( window ).on( 'load.hume', onResizeARIA );
		$( window ).on( 'resize.hume', onResizeARIA );
	});
