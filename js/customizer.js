...
( function( $ ) {
	...
	wp.customize( 'interactive_color', function( value ) {
		value.bind( function( to ) {
			$( 'a:hover,a:focus,a:active,.page-content a:focus, .page-content a:hover,.entry-content a:focus,.entry-content a:hover,.entry-summary a:focus,.entry-summary a:hover,.comment-content a:focus,.comment-content a:hover,.cat-links a,.social-menu ul a.widget_hume_recent_posts a:hover .title,.widget_hume_recent_posts a:focus .title,.widget_hume_recent_comments a:focus .original-title,.widget_hume_recent_comments a:hover .original-title,.pagination .current' ).css( {
