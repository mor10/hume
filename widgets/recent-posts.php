...
class hume_recent_posts extends WP_Widget {

	function __construct() {
        $widget_ops = array( 'classname' => 'widget_hume_recent_posts', 'description' => __('Displays most recent posts with featured image and publishing date.', 'hume') );
        parent::__construct( 'widget_hume_recent_posts', __('Enhanced Recent Posts','hume'), $widget_ops );
    }
	...
	function widget($args, $instance) {
		...
		if (!empty($widget_title)) {
			...
			echo $before_title . esc_html__( 'Recent Posts', 'hume' ) . $after_title;
		}
		?>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php  _e('Title', 'hume'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('number_of_posts'); ?>"><?php _e('Number of posts to display', 'hume'); ?>:
...
register_widget('hume_recent_posts');
...
/*
function hume_posts_widget_registration() {
  unregister_widget('WP_Widget_Recent_Posts');
  register_widget('hume_recent_posts');
}
add_action('widgets_init', 'hume_posts_widget_registration');
*/